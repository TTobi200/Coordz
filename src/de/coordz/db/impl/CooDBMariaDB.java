...
public class CooDBMariaDB extends CooDBSimple
{
	private static final String MYSQL_CLIENT_DRIVER = "org.mariadb.jdbc.Driver";

	@Override
	public void connect(String dbHost, String dbPort, String dbName,
		String usrName, String password, boolean create)
	{
		CooLog.debug("Establish connection to Maria database <" + dbName + ">");
		
		// Create the database connection url
		dbURL = new StringBuilder("jdbc:mariadb://");
		...
		{
			CooLog.error("Error while establish Maria "
				+ "DB connection", e);
		}
	}
	...
	public void shutdown()
	{
		...
		{
			CooLog.error("Error While closing Maria "
				+ "DB connection", e);
		}
	}
	...
	{
		CooLog.debug("Clean up Maria database instance");
	...
	public String getDataType(CooDBValTypes type, String column)
	{
		...
		{
			case BOOLEAN:
				// MariaDB will convert this to an TINYINT
